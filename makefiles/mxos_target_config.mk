...
PLATFORM_FULL   	:=$(strip $(foreach comp,$(subst .,/,$(COMPONENTS)),$(if $(wildcard $(MXOS_OS_PATH)/board/$(comp)),$(MXOS_OS_PATH)/board/$(comp),$(if $(wildcard $(SOURCE_ROOT)/board/$(comp)),$(SOURCE_ROOT)/board/$(comp), ))))
...
EXTRA_CFLAGS += -DMXOS_OS_USER_NAME=\"$(MXOS_OS_USER_NAME)\"
