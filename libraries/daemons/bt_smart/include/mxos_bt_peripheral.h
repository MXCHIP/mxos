 ...
 */
typedef mret_t (* mxos_bt_peripheral_connection_callback_t) ( mxos_bt_peripheral_socket_t* socket );

/**
 * Socket disconnection callback
 */
typedef mret_t (* mxos_bt_peripheral_disconnection_callback_t) ( mxos_bt_peripheral_socket_t* socket );
 ...
 *
 *
 * @return MXOS_BT_SUCCESS: success , else @ref mret_t
 */
 ...
 *
 * @return MXOS_BG_SUCCESS, else @ref mret_t
 */
mret_t mxos_bt_peripheral_start_advertisements( mxos_bt_smart_advertising_settings_t* settings, 
 ...
 * @return @ref mret_t
 */
mret_t mxos_bt_peripheral_ext_attribute_value_write( mxos_bt_ext_attribute_value_t* attribute, uint16_t length, uint16_t value_offset, const uint8_t* value );
 ...
 * @return @ref mret_t
 */
mret_t mxos_bt_peripheral_ext_attribute_remove_all( void );
