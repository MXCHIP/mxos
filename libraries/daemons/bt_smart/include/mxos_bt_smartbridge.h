 ...
 */
typedef OSStatus (*mxos_bt_smartbridge_disconnection_callback_t)       ( mxos_bt_smartbridge_socket_t* socket );

/**
 * Socket GATT notification callback
 */
typedef OSStatus (*mxos_bt_smartbridge_notification_callback_t)        ( mxos_bt_smartbridge_socket_t* socket, uint16_t attribute_handle );

/**
 * BLE Auto connection callback 
 */
typedef OSStatus (*mxos_bt_smartbridge_auto_connection_callback_t)     ( mxos_bt_smartbridge_socket_t *socket );

/**
 * BLE Auto connection parameters callback -- auto connection procedure callback
 */
typedef OSStatus (*mxos_bt_smartbridge_auto_connection_parms_cback_t)   ( const mxos_bt_device_address_t random_bda, const char *name, const uint8_t *p_data, uint8_t len, mxos_bt_smartbridge_auto_conn_cback_parms_t *parm );
 ...
 * @return @ref OSStatus
 */
OSStatus mxos_bt_smartbridge_start_scan( const mxos_bt_smart_scan_settings_t*        settings,
 ...
 * @return @ref OSStatus
 */
OSStatus mxos_bt_smartbridge_connect( mxos_bt_smartbridge_socket_t*                socket,
 ...
 * @return @ref OSStatus
 */
OSStatus mxos_bt_smartbridge_set_bond_info( mxos_bt_smartbridge_socket_t*            socket,
 ...
 * @return @ref OSStatus
 */
OSStatus mxos_bt_smartbridge_enable_pairing( mxos_bt_smartbridge_socket_t*             socket,
                                              const mxos_bt_smart_security_settings_t* settings,
 ...
 * @return OSStatus
 */
OSStatus mxos_bt_smartbridge_write_attribute_cache_characteristic_value( mxos_bt_smartbridge_socket_t* socket, const mxos_bt_smart_attribute_t* characteristic_value );
