...
static void smartbridge_gatt_disconnection_handler( uint16_t connection_handle )
{
    ...
    if ( bt_smartbridge_socket_manager_remove_socket( connection_handle, &removed_socket ) == MXOS_BT_SUCCESS )
    {
        ...
        else
        {
            ...
            {
                mxos_rtos_send_asynchronous_event( MXOS_BT_EVT_WORKER_THREAD, smartbridge_app_disconnection_handler, (void*)removed_socket );
            }
...
static merr_t smartbridge_gatt_notification_indication_handler( mxos_bt_gatt_operation_complete_t* operation_complete )
{
    ...
    if ( bt_smartbridge_socket_manager_find_socket_by_handle( connection_handle, &socket ) == MXOS_BT_SUCCESS )
    {
        ...
        {
            if( kNoErr != mxos_rtos_send_asynchronous_event( MXOS_BT_EVT_WORKER_THREAD, smartbridge_app_notification_handler, (void*)socket ) )
            {
...
//         {
//             mxos_rtos_send_asynchronous_event( MXOS_BT_EVT_WORKER_THREAD, smartbridge_app_pairing_handler, (void*)socket );
//         }
...
err_exit:
            ...
            /* Next Connection */
            mxos_rtos_send_asynchronous_event(MXOS_BT_WORKER_THREAD, 
