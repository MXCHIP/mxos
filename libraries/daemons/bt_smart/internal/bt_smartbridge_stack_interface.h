...
OSStatus  smartbridge_bt_interface_start_scan( const mxos_bt_smart_scan_settings_t* setting, mxos_bt_smart_scan_complete_callback_t complete_callback, mxos_bt_smart_advertising_report_callback_t advertising_report_callback );
...
OSStatus  smartbridge_bt_interface_set_background_connection_type(mxos_bt_smartbridge_auto_connection_type_t type, const mxos_bt_smart_scan_settings_t* settings, mxos_bt_smartbridge_auto_connection_parms_cback_t );
