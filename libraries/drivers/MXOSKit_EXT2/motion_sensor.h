...
/** @defgroup MXOSKIT_EXT_Motion_Sensor_Driver MXOSKit Ext Motion Sensor Driver
  * @brief Provide driver interface for MXOSKit Ext motion sensor
  * @{
  */
...
/**
 * @brief Initialize MXOSKit Ext - motion sensor Devices.
 *
...
/**
 * @brief Read data from MXOSKit Ext - motion sensor Devices.
 *
 * @return   kNoErr        : on success.
 * @return   kGeneralErr   : if an error occurred
 */
...
/**
 * @brief Deinitialize MXOSKit Ext - motion sensor Devices.
 *
 * @return   kNoErr        : on success.
 * @return   kGeneralErr   : if an error occurred
 */
