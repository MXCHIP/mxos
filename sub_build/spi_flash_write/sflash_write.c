...
{
    [BOOTLOADER_FIRMWARE_PARTITION_TCL]         = MXOS_PARTITION_BOOTLOADER,
    [APPLICATION_FIRMWARE_PARTITION_TCL]        = MXOS_PARTITION_APPLICATION,
    [ATE_FIRMWARE_PARTITION_TCL]                = MXOS_PARTITION_ATE,
    [WIFI_FIRMWARE_PARTITION_TCL]               = MXOS_PARTITION_RF_FIRMWARE,
    [PARAMETER_1_IMAGE_PARTITION_TCL]           = MXOS_PARTITION_PARAMETER_1,
    [PARAMETER_2_IMAGE_PARTITION_TCL]           = MXOS_PARTITION_PARAMETER_2,
#ifdef MXOS_USE_BT_PARTITION
    [BT_PATCH_FIRMWARE_PARTITION_TCL]           = MXOS_PARTITION_BT_FIRMWARE,
#else
    [BT_PATCH_FIRMWARE_PARTITION_TCL]           = -1,
#endif
    [FILESYSTEM_IMAGE_PARTITION_TCL]            = MXOS_PARTITION_FILESYS,
