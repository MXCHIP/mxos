 ...
 * @return @ref merr_t
 */
merr_t platform_gpio_init( platform_gpio_driver_t* driver, const platform_gpio_t* gpio, platform_pin_config_t config );
 ...
 * @return @ref merr_t
 */
merr_t platform_gpio_deinit( platform_gpio_driver_t* driver );
 ...
 * @return @ref merr_t
 */
merr_t platform_gpio_output_high( platform_gpio_driver_t* driver );
 ...
 * @return @ref merr_t
 */
merr_t platform_gpio_output_low( platform_gpio_driver_t* driver );
 ...
 * @return @ref merr_t
 */
merr_t platform_gpio_output_trigger( platform_gpio_driver_t* driver );
 ...
 * @return @ref merr_t
 */
merr_t platform_gpio_irq_enable( platform_gpio_irq_driver_t* irq_driver, const platform_gpio_t* gpio, platform_gpio_irq_trigger_t trigger, platform_gpio_irq_callback_t handler, void* arg );
 ...
 * @return @ref merr_t
 */
merr_t platform_gpio_irq_disable( platform_gpio_irq_driver_t* irq_driver );
 ...
 * @return @ref merr_t
 */
merr_t platform_uart_init( platform_uart_driver_t* driver, const platform_uart_t* peripheral,
 ...
 * @return @ref merr_t
 */
merr_t platform_uart_receive_bytes( platform_uart_driver_t* driver, uint8_t* data_in, uint32_t expected_data_size,
                                      uint32_t timeout_ms );
...
merr_t platform_wlan_spi_init( platform_gpio_driver_t* cs_drv, const platform_gpio_t* cs);
...
merr_t platform_wlan_spi_deinit( platform_gpio_driver_t* cs_drv );
...
merr_t platform_wlan_spi_transfer( platform_gpio_driver_t* cs_drv, const platform_spi_message_segment_t* segments, uint16_t number_of_segments );
 ...
 * @return @ref merr_t
 */
merr_t platform_i2c_init_tx_message( platform_i2c_message_t* message, const void* tx_buffer,
 ...
 * @return @ref merr_t
 */
merr_t platform_i2c_init_rx_message( platform_i2c_message_t* message, void* rx_buffer, uint16_t rx_buffer_length,
                                       uint16_t retries );
 ...
 * @return @ref merr_t
 */
merr_t platform_i2c_init_combined_message( platform_i2c_message_t* message, const void* tx_buffer,
 ...
 * @return @ref merr_t
 */
merr_t platform_i2c_transfer( platform_i2c_driver_t* driver, const platform_i2c_config_t* config,
