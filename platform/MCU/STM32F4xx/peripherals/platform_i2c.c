...
static mret_t i2c_address_device( const platform_i2c_t* i2c, const platform_i2c_config_t* config, int retries, uint8_t direction );
static mret_t i2c_wait_for_event( I2C_TypeDef* i2c, uint32_t event_id, uint32_t number_of_waits );
static mret_t i2c_transfer_message_no_dma( const platform_i2c_t* i2c, const platform_i2c_config_t* config, platform_i2c_message_t* message );
#ifdef I2C_USE_DMA
static mret_t i2c_rx_with_dma( const platform_i2c_t* i2c, const platform_i2c_config_t* config, platform_i2c_message_t* message );
static mret_t i2c_tx_with_dma( const platform_i2c_t* i2c, const platform_i2c_config_t* config, platform_i2c_message_t* message );
#else
static mret_t i2c_tx_no_dma( const platform_i2c_t* i2c, const platform_i2c_config_t* config, platform_i2c_message_t* message );
static mret_t i2c_rx_no_dma( const platform_i2c_t* i2c, const platform_i2c_config_t* config, platform_i2c_message_t* message );
#endif
...
#ifdef I2C_USE_DMA
static mret_t i2c_dma_config_and_execute( mxos_i2c_device_t* device, mxos_i2c_message_t* message, bool tx_dma  )
{
  uint32_t counter;
...
static mret_t i2c_dma_transfer( mxos_i2c_device_t* device, mxos_i2c_message_t* message )
{
  mret_t       result;
  uint32_t       counter;
  int            i = 0;
