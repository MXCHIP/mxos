 ...
 ******************************************************/
static mret_t stm32f2_rtc_change_clock                   ( rtc_clock_state_t* current, rtc_clock_state_t target );
...
static mret_t compensate_time_error                      ( uint32_t sec, bool subtract );
