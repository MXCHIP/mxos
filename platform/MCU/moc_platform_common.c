...
mret_t mxos_rtc_get_time(mxos_rtc_time_t* time)
{
  return (mret_t) platform_rtc_get_time( time );
}

mret_t mxos_rtc_set_time(mxos_rtc_time_t* time)
{
  return (mret_t) platform_rtc_set_time( time );
}
