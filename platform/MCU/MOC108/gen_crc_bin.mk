...
ifeq ($(HOST_OS),Win32)
CRC := "$(SOURCE_ROOT)/mxos/platform/MCU/MOC108/tools/crc/win/crc.exe"
XZ 		:= "$(SOURCE_ROOT)/mxos/platform/MCU/MOC108/tools/xz/win/xz.exe"
else  # Win32
ifeq ($(HOST_OS),Linux32)
CRC := "$(SOURCE_ROOT)/mxos/platform/MCU/MOC108/tools/crc/linux/crc"
XZ 		:= "$(SOURCE_ROOT)/mxos/platform/MCU/MOC108/tools/xz/linux/xz"
else # Linux32
...
ifeq ($(HOST_OS),OSX)
CRC := "$(SOURCE_ROOT)/mxos/platform/MCU/MOC108/tools/crc/osx/crc"
XZ 		:= "$(SOURCE_ROOT)/mxos/platform/MCU/MOC108/tools/xz/osx/xz"
else # OSX
...
ADD_MD5_SCRIPT := $(SOURCE_ROOT)/mxos/platform/MCU/MOC108/tools/add_md5.py
...
#bootloader
BOOT_BIN_FILE := $(MXOS_OS_PATH)/resources/moc_kernel/$(MODULE)/boot.bin
BOOT_OFFSET   := 0x0
...
#ate firmware
ATE_BIN_FILE := $(MXOS_OS_PATH)/resources/ate_firmware/$(MODULE)/ate.bin
ATE_OFFSET := 0x100100
