/**
 ******************************************************************************
 * @file    mxos_system_time.c
 * @author  William Xu
 * @version V1.0.0
 * @date    22-Aug-2016
 * @brief   This file provide the time functions from MXOS system.
 ******************************************************************************
 *
...
static mxos_utc_time_ms_t current_utc_time = 0;
static mxos_time_t        last_utc_time_mxos_reference = 0;
...
OSStatus mxos_time_get_utc_time( mxos_utc_time_t* utc_time )
{
    ...
    mxos_time_get_utc_time_ms( &utc_time_ms );
...
OSStatus mxos_time_get_utc_time_ms( mxos_utc_time_ms_t* utc_time_ms )
{
    ...
    if ( time_since_last_reference != 0 )
    {
        ...
        last_utc_time_mxos_reference = temp_mxos_time;
    }
...
OSStatus mxos_time_convert_utc_ms_to_iso8601( mxos_utc_time_ms_t utc_time_ms, iso8601_time_t* iso8601_time )
{
    ...
    is_a_leap_year = ( IS_LEAP_YEAR( year ) ) ? MXOS_TRUE : MXOS_FALSE;
